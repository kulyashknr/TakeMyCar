...
var ensurePNGIsNotTransparent = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(imagePath) {
    var hasAlreadyResolved;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt('return', new (_promise || _load_promise()).default(function (res, rej) {
              var stream = (_fsExtra || _load_fsExtra()).default.createReadStream(imagePath);
