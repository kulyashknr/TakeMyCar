...
var selectPushKey = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(context) {
    ...
    var pushKeys, choices, _ref2, pushKey;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            choices = [{ name: '[Upload an existing key]', value: 'UPLOAD' }].concat((0, (_toConsumableArray2 || _load_toConsumableArray()).default)(pushKeys));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 26:
            ...
            _context2.next = 29;
            return selectPushKey(context, { disableCreate: true });
