...
const optimizeImageAsync = exports.optimizeImageAsync = (() => {
  var _ref = _asyncToGenerator(function* (image, newName) {
    ...
    if (format === 'jpeg') {
      yield (0, (_sharp || _load_sharp()).default)(newName).jpeg({ quality: 60 }).toFile(image).catch(function (err) {
        return (_Logger || _load_Logger()).default.global.error(err);
      });
    } else {
      yield (0, (_sharp || _load_sharp()).default)(newName).png({ quality: 60 }).toFile(image).catch(function (err) {
        return (_Logger || _load_Logger()).default.global.error(err);
      });
    }
  });

  return function optimizeImageAsync(_x, _x2) {
...
const hasUnoptimizedAssetsAsync = exports.hasUnoptimizedAssetsAsync = (() => {
  ...
  return function hasUnoptimizedAssetsAsync(_x3, _x4) {
...
const getAssetFilesAsync = exports.getAssetFilesAsync = (() => {
  ...
  return function getAssetFilesAsync(_x5, _x6) {
...
const readAssetJsonAsync = exports.readAssetJsonAsync = (() => {
  ...
  return function readAssetJsonAsync(_x7) {
